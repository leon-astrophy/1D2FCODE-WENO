...
! Find constant !
a_max1 = (gs1*me1**4)/(4.8D1*pi_old**2*h_bar**3)
a_max2 = (gs2*me2**4)/(4.8D1*pi_old**2*h_bar**3)
b_max1 = (mb1/ye1)*((gs1*me1**3)/(6.0E0_DP*pi_old**2*h_bar**3))
b_max2 = (mb2/ye2_old + me2)*((gs2*me2**3)/(6.0E0_DP*pi_old**2*h_bar**3))
